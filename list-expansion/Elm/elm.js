...
Elm.ListItem = Elm.ListItem || {};
Elm.ListItem.make = function (_elm) {
   "use strict";
   _elm.ListItem = _elm.ListItem || {};
   if (_elm.ListItem.values) return _elm.ListItem.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.ListItem.values = {_op: _op,init: init,update: update,view: view};
};
Elm.ListItemList = Elm.ListItemList || {};
Elm.ListItemList.make = function (_elm) {
   "use strict";
   _elm.ListItemList = _elm.ListItemList || {};
   if (_elm.ListItemList.values) return _elm.ListItemList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $ListItem = Elm.ListItem.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Insert": var newListItem = {ctor: "_Tuple2",_0: model.nextID,_1: $ListItem.init(0)};
           var newListItems = A2($Basics._op["++"],model.listItems,_U.list([newListItem]));
           return _U.update(model,{listItems: newListItems,nextID: model.nextID + 1});
         case "Remove": return _U.update(model,{listItems: A2($List.drop,1,model.listItems)});
         default: var updateListItem = function (_p1) {
              var _p2 = _p1;
              var _p4 = _p2._1;
              var _p3 = _p2._0;
              return _U.eq(_p3,_p0._0) ? {ctor: "_Tuple2",_0: _p3,_1: A2($ListItem.update,_p0._1,_p4)} : {ctor: "_Tuple2",_0: _p3,_1: _p4};
           };
           return _U.update(model,{listItems: A2($List.map,updateListItem,model.listItems)});}
   });
   var Modify = F2(function (a,b) {    return {ctor: "Modify",_0: a,_1: b};});
   var viewListItem = F2(function (address,_p5) {    var _p6 = _p5;return A2($ListItem.view,A2($Signal.forwardTo,address,Modify(_p6._0)),_p6._1);});
   var Remove = {ctor: "Remove"};
   var Insert = {ctor: "Insert"};
   var view = F2(function (address,model) {
      ...
      var listItems = A2($List.map,viewListItem(address),model.listItems);
      return A2($Html.div,_U.list([]),A2($Basics._op["++"],_U.list([remove,insert]),listItems));
   });
   var init = {listItems: _U.list([]),nextID: 0};
   var Model = F2(function (a,b) {    return {listItems: a,nextID: b};});
   return _elm.ListItemList.values = {_op: _op
                                     ,Model: Model
                                     ,init: init
                                     ,Insert: Insert
                                     ,Remove: Remove
...
Elm.Main.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $ListItemList = Elm.ListItemList.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var _op = {};
   var main = $StartApp$Simple.start({model: $ListItemList.init,update: $ListItemList.update,view: $ListItemList.view});
